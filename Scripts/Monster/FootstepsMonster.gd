...
# If you change anything here, you will likely also want to change Player/FootstepsPlayer
...
func get_step_stream():
	return load("res://Sound/Effects/Monster/Brain Boi Walking/brain_boi_walking_step" + step_array[index] + ".wav")
